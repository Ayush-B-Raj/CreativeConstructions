...
if(isset($_POST['btn_update']))
{
    ...
    if($row['supervisor_password']==$OLD){
      
       if($NEW==$CRM){
      
        $insQR="update tbl_supervisor set supervisor_password='$NEW' where supervisor_id='". $_SESSION['sid']."'";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="txt_oldpass" id="txt_oldpass"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="txt_confirmpass"
                                    id="txt_confirmpass" />
                            </div>
                        </div>
