...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>CREATIVE CONSTRUCTIONS</title>        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        ...
        <div class="wrapper">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img src="../Assets/Templates/Main/img/carousel-1.png" alt="Carousel Image">
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["uname"]; ?></h1>
                        </div>
                    </div>

                    <div class="carousel-item">
                    <img src="..\Assets\Templates\Main\img\carousel-2.png" alt="Carousel Image">
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["uname"]; ?></h1>
                        </div>
                    ...
                    <div class="carousel-item">
                    <img src="../Assets/Templates/Main/img/carousel-3.png" alt="Carousel Image">
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["uname"]; ?></h1>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="about-img">
                                <img src="../Assets/Templates/Main/img/about.png" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-6">
                            <div class="section-header text-left">
                                <p>Welcome to CREATIVE CONSTRUCTIONS</p>
                                <h2>25 Years Experience</h2>
                            </div>
                            <div class="about-text">
                                <p>
                                    We have 25 years of experience in firm  and we have assisted 45 repeated clients in increasing their capital by an average of 15% every year. We trained them in providing the most helpful experience to our customers.  We aim to integrate our individualized approach to helping the clients”
                                <p>
                        ...
                        <div class="col-md-6 fact-left wow slideInLeft">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fact-text">
                                        <h2 data-toggle="counter-up">585</h2>
                                        <p>Happy Clients</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-11.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>Building Construction</h3>
                                    <a href="../Assets/Templates/Main/img/service-11.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-22.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>House Renovation</h3>
                                    <a  href="../Assets/Templates/Main/img/service-22.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-33.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>Architecture Design</h3>
                                    <a  href="../Assets/Templates/Main/img/service-33.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-44.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>Interior Design</h3>
                                    <a  href="../Assets/Templates/Main/img/service-44.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-55.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>Fixing & Support</h3>
                                    <a href="../Assets/Templates/Main/img/service-55.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="../Assets/Templates/Main/img/service-66.jpg" alt="Image">
                                    
                                </div>
                                <div class="service-text">
                                    <h3>Painting</h3>
                                    <a href="../Assets/Templates/Main/img/service-66.jpg" data-lightbox="service"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../Assets/Templates/Main/img/team-1.png" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>JOHN PANACKAL</h2>
                                    <p>CEO & Founder</p>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../Assets/Templates/Main/img/team-2.png" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>GLADWIN P JOJO </h2>
                                    <p>Civil Engineer</p>
                                </div>
                                <div class="team-social">
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../Assets/Templates/Main/img/team-3.png" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>ANANTHA KRISHNA</h2>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../Assets/Templates/Main/img/team-4.png" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>AYUSH B RAJ</h2>
                                    <p>Supervisor</p>
